...
purl("wrangle/cps.Rmd", output = "code/viz/temp/cps.R") %>% source()
purl("wrangle/nc_wrangle.Rmd", output = "code/viz/temp/nc.R") %>% source()
purl("code/tidy_cces.Rmd", output = "code/viz/temp/cces.R") %>% source()
```
