...
if(!dir.exists("code/temp")) dir.create("code/temp")
purl("data-raw/wrangle/cps.Rmd", output = "code/temp/cps.R") %>% source()
purl("data-raw/wrangle/nc_wrangle.Rmd", output = "code/temp/nc.R") %>% source()
purl("data-raw/wrangle/tidy_cces.Rmd", output = "code/temp/cces.R") %>% source()
```
